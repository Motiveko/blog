---
title: "CJS vs ESM: JavaScript 모듈 시스템 완벽 비교 분석 (프론트엔드 개발자 필독)"
...
```javascript title="cjs-module.js (CJS)"
// 모듈 내보내기
const PI = 3.14;
...
```javascript title="esm-module.mjs (ESM)"
